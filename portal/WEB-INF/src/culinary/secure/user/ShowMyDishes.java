...
public class ShowMyDishes extends ActionSupport implements
ServletContextAware,UserAware {
	...
	public String execute() throws Exception {
		...
		ResultSet rs = new SQLQuery(context.getAttribute("dbConn")).select("SELECT DISHES.*, CATEGORIES.* FROM DISHES,CATEGORIES WHERE USER_ID='"+user.getId()+"' AND DISHES.CATEGORY_ID=CATEGORIES.ID AND DISHES.STATUS='1';");
